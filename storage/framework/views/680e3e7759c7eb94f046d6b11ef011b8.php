                ...
                <section class="profile-sec pb">
                    <div class="profile-banner">
                        <div class="banner-image img-wrapper">
                            <img src="<?php echo e(isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme11/images/profile-banner.png')); ?>" alt="profile-banner-img" id="banner_preview"  class="profile-banner-img" loading="lazy">
                        </div>
                    </div>
                    <div class="client-info-wrp d-flex align-items-center">
                        <div class="client-image">
                            <img id="business_logo_preview"  src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme11/images/client-image.png')); ?>"   alt="client-image" loading="lazy">
                        </div>
                                            ...
                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>" class="d-flex align-items-center">
                                                <?php if($key1 == 'Address'): ?>
                                                    ...
                                                    <div class="contact-image">
                                                        <img src="<?php echo e(asset('custom/theme11/icon/' . $color . '/' . strtolower($key1) . '.svg')); ?>" class="img-fluid">
                                                    </div>
                                    ...
                                    <div class="testimonial-card-inner">
                                        ...
                                        <div class="testimonial-content">
                                            ...
                                            <div class="testimonial-content-bottom">
                                                <span  id="<?php echo e('testimonial_name_' . $testimonials_row_nos . '_preview'); ?>">
...
<?php echo $__env->make('card.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/card/theme11/index.blade.php ENDPATH**/ ?>