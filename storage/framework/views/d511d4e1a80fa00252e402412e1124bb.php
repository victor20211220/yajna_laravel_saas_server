...
<?php endif; ?>
        <div class="input-group">
            <input class="form-control" required="required" name="storage_limit" type="number" id="storage_limit" placeholder="<?php echo e(__('Enter Storage limit')); ?>"
                min=1>
    ...
    <div class="form-group col-md-6 trial_day">
        ...
        <?php echo e(Form::number('trial_day', null, ['class' => 'form-control', 'id' => 'trial_day_input', 'min' => '1','placeholder' => __('Enter number of trial days')])); ?>
                        ...
                        <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($module->getName() != 'LandingPage'): ?>
                                ...
                                <li>
                                    ...
                                    <label for="checkthis<?php echo e($loop->index); ?>"><img src="<?php echo e(\App\Models\Utility::get_module_img($module->getName())); ?><?php echo e('?' . time()); ?>" /></label>
                                </li>
                            <?php endif; ?>
...
<?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/plan/create.blade.php ENDPATH**/ ?>