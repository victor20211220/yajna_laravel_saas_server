...
<head>
    ...
    <!-- font css -->
    <link rel="stylesheet" href=" <?php echo e(asset('Modules/LandingPage/Resources/assets/fonts/tabler-icons.min.css')); ?>" />
    <link rel="stylesheet" href=" <?php echo e(asset('Modules/LandingPage/Resources/assets/fonts/feather.css')); ?>" />
    <link rel="stylesheet" href="  <?php echo e(asset('Modules/LandingPage/Resources/assets/fonts/fontawesome.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('Modules/LandingPage/Resources/assets/fonts/material.css')); ?>" />



    <!-- vendor css -->
    <link rel="stylesheet" href="  <?php echo e(asset('Modules/LandingPage/Resources/assets/css/style.css')); ?>" />
    <link rel="stylesheet" href=" <?php echo e(asset('Modules/LandingPage/Resources/assets/css/customizer.css')); ?>" />
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <nav class="woocommerce-breadcrumb" aria-label="breadcrumbs">
                                        <a href="<?php echo e(url('/')); ?>">Home</a><span
                                        ...
                                        <form role="search" method="get" class="search-form" id="product_search"
                                            ...
                                            <div class="search_box search-box">
                                                ...
                                                <input type="search" class="search-field"
                                                    placeholder="<?php echo e(__('Search for any Business...')); ?>"
                    ...
                    <section class="directory-category-section">
                        <div class="container">
                            <div class="section-title text-center">
                                <h2><?php echo e(__('Top Categories')); ?></h2>
                                <p><?php echo e(__('Discover a diverse range of top categories on vCardgo.Find evenything you need in one convenient place.')); ?>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="category-body-div">
                                                ...
                                                <div class="category-name">
                                                    ...
                                                    <span><?php echo e($category->count . ' Business'); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <section class="directory-discover-section" id="business-tab">
                        <div class="container">
                            <div class="section-title-wrp d-flex">
                                <div class="section-title text-center">
                                    <h2><?php echo e(__('Discover Business')); ?></h2>
                                    <p><?php echo e(__('Dive into vCardGo`s extensive array of categories, covering everything from essential services to leisure activities. Explore and discover the perfect solutions for all your needs in one convenient platform.')); ?>
...
<?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/Modules/LandingPage/Resources/views/marketplace/index.blade.php ENDPATH**/ ?>