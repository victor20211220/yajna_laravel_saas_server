...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-xxl-7 col-xl-12 col-12">
                    <div class="row row-gaps">
                            ...
                            <div class="dashboard-card">
                                ...
                                <div class="card-inner">
                                    <div class="card-content">
                                        <h3 class="text-white"><?php echo e(__('Good Morning')); ?></h3>
                                        <p><?php echo e(__('Have a nice day! Did you know that you can quickly add your favorite card to the business?')); ?></p>
                                        ...
                                        <span><?php echo e(__('Quick add')); ?></span> </button>
                                        <div class="dropdown-menu">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create business')): ?>
                                                <a href="#" data-size="xl" data-url="<?php echo e(route('business.create')); ?>"
                                                    ...
                                                    title="<?php echo e(__('create Business')); ?>" data-bs-original-title="<?php echo e(__('create Business')); ?>">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create user')): ?>
                                                <a href="#" data-size="md" data-url="<?php echo e(route('users.create')); ?>"
                                                    ...
                                                    data-bs-placement="top" data-bs-toggle="tooltip"
                                                    title="<?php echo e(__('create User')); ?>" data-bs-original-title="<?php echo e(__('create User')); ?>">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create role')): ?>
                                                <a href="#" data-size="lg" data-url="<?php echo e(route('roles.create')); ?>"
                                                    ...
                                                    data-bs-placement="top" data-bs-toggle="tooltip"
                                                    title="<?php echo e(__('create Role')); ?>" data-bs-original-title="<?php echo e(__('create Role')); ?>">
                                    ...
                                    <div class="card-body shareqrcode-card">
                                        ...
                                        <div class="d-flex copylink-btn-wrapper justify-content-between">
                                            <a href="#!" class="btn w-100 cp_link"
                                                ...
                                                title="" data-bs-original-title="<?php echo e(__('Click to copy business link')); ?>">
                                                <span><?php echo e(__('Business Link')); ?></span>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 d-flex h-100">
                                <div class="card w-100 mb-0">
                                    <div class="card-body shareqrcode-card">
                                        <img src="<?php echo e(asset('storage/qr.png')); ?>" alt="QR Code">
                                    </div>
                                </div>
                            </div>
                        <?php endif; ?>
                                    ...
                                    <div class="dashboard-project-card">
                                        <div class="card-inner  d-flex justify-content-between">
                                            <div class="card-content">
                                                ...
                                                <a href="<?php echo e(route('business.index')); ?>"><h3 class="mt-3 mb-0 text-danger"><?php echo e(__('Total Business')); ?></h3></a>
                                            </div>
                                        ...
                                        <div class="card-inner  d-flex justify-content-between">
                                            <div class="card-content">
                                                ...
                                                <a href="<?php echo e(route('appointments.index')); ?>">
                                                    <h3 class="mt-3 mb-0"><?php echo e(__('Total Appointments')); ?></h3></a>
                                            </div>
                                        ...
                                        <div class="card-inner  d-flex justify-content-between">
                                            <div class="card-content">
                                                ...
                                                <a href="<?php echo e(route('users.index')); ?>">
                                                    <h3 class="mt-3 mb-0"><?php echo e(__('Total Staff')); ?></h3></a>
                                            </div>
                ...
                <div class="col-xxl-5 col-xl-6 col-lg-6 d-flex flex-column">
                    <div class="card dashboard-theme-card theme-preview theme-preview-1 mb-0">
                        <div class="theme-preview-body">
                            <img src="<?php echo e(asset(Storage::url('uploads/card_theme/' . $theme . '/' . $color . '.png'))); ?>" class="theme_preview_img">

                        </div>
                        <div class="theme-preview-btn text-center mt-3">
                            <?php if(isset($business1)): ?>
                            <a href="<?php echo e(route('business.edit',  $business1->id)); ?>" class="btn btn-primary"><?php echo e(__('Edit Business')); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript">
         ...
         <script>
            ...
            var options = {
                ...
                labels: ["<?php echo e(__('Other')); ?>", "<?php echo e(__('Webkit')); ?>", "<?php echo e(__('Android')); ?>", "<?php echo e(__('iPhone')); ?>"],
                legend: {
                    show: true,
                    position: 'bottom',
                },
            ...
            var options = {
                ...
                series: <?php echo json_encode($devicearray['data']); ?>,
                colors: ["#6fd943", '#ffa21d', '#FF3A6E', '#3ec9d6'],
                labels: ["<?php echo e(__('Chrome')); ?>", "<?php echo e(__('Firefox')); ?>", "<?php echo e(__('Internet Explorer')); ?>",
                    "<?php echo e(__('Microsoft Edge')); ?>"
                ],
                legend: {
                    show: true,
                    position: 'bottom',
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/dashboard/dashboard.blade.php ENDPATH**/ ?>