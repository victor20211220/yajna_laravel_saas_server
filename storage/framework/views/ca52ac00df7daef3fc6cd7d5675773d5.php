            ...
            <div class="lawyer-card">
                <section class="profile-sec pb">
                    <div class="profile-banner">
                        <img src="<?php echo e(isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme7/images/profile-banner.png')); ?>" class="profile-banner-img" alt="profile-banner-img" id="banner_preview" loading="lazy">
                        <div class="container">
                            <div class="section-title">
                            <h2 id="<?php echo e($stringid . '_title'); ?>_preview"><?php echo e($business->title); ?></h2>
                            </div>
                            <div class="client-image">
                                <img id="business_logo_preview"  src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme7/images/client-image.png')); ?>"   alt="client-image" loading="lazy">
                            </div>
                        </div>
                    </div>
                    <div class="container">
                        <div class="client-info text-center">
                            <h3 id="<?php echo e($stringid . '_subtitle'); ?>_preview"><?php echo e($business->sub_title); ?></h3>
                                        ...
                                        <li id="contact_<?php echo e($loop->parent->index + 1); ?>" class="d-flex align-items-center justify-content-center">
                                            <?php if($key1 == 'Address'): ?>
                                                ...
                                                <div class="contact-image">
                                                    <img src="<?php echo e(asset('custom/theme7/icon/color1/' . strtolower($key1) . '.svg')); ?>" class="img-fluid">
                                                </div>
...
<?php echo $__env->make('card.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/card/theme7/index.blade.php ENDPATH**/ ?>