                    ...
                    <div class="card">
                        ...
                        <div class="card-header d-flex align-items-center justify-content-between gap-2">
                            ...
                            <div class="form-check form-switch custom-switch-v1">
                                <input type="checkbox" class="form-check-input input-primary" name="faq_status"
...
<?php unset($__componentOriginaleab1765d328ab3f8835fc5d78676a070); ?>
<?php endif; ?>
                                        <?php echo e(Form::text('faq_description', $settings['faq_description'], ['class' => 'form-control', 'placeholder' => __('Enter Description'), 'required' => 'required'])); ?>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-3 justify-content-end d-flex">
                                    <a data-size="lg" data-url="<?php echo e(route('faq_create')); ?>" data-ajax-popup="true"
                                        data-bs-toggle="tooltip" data-title="<?php echo e(__('Create FAQ')); ?>"
                                        title="<?php echo e(__('Create FAQ')); ?>" class="btn btn-sm btn-primary">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/Modules/LandingPage/Resources/views/landingpage/faq/index.blade.php ENDPATH**/ ?>