...
<?php if($themeName): ?>
<div class="<?php echo e($themeName); ?>" id="view_theme21">
<?php else: ?>
<div class="<?php echo e($business->theme_color); ?>" id="view_theme21">
<?php endif; ?>
        <main id="boxes">
                ...
                <div class="food-chef-card">
                    <section class="profile-sec pb">
                        <div class="profile-banner">
                               <img src="<?php echo e(isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme21/images/profile-banner.png')); ?>" alt="profile-banner" id="banner_preview" loading="lazy">
                        ...
                        <div class="client-info-wrp">
                            <div class="container">
                                ...
                                <div class="client-image">
                                    <img id="business_logo_preview"  src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme21/images/client-image.png')); ?>"   alt="client-image" loading="lazy">
                                </div>
                                                        ...
                                                        <li id="contact_<?php echo e($loop->parent->index + 1); ?>" class="d-flex align-items-center">
                                                            <?php if($key1 == 'Address'): ?>
                                                                ...
                                                                <div class="contact-image">
                                                                    <img src="<?php echo e(asset('custom/theme21/icon/color1/' . strtolower($key1) . '.svg')); ?>" class="img-fluid">
                                                                </div>
...
<?php echo $__env->make('card.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/card/theme21/index.blade.php ENDPATH**/ ?>