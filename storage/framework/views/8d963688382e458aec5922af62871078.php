    ...
    <div class="row row-gap mb-4">
        <div class="col-xxl-4 col-md-6 dash-card">
            <div class="dashboard-info-card">
                ...
                <a href="<?php echo e(route('users.index')); ?>" class="top-info">
                    <span class="h4"><?php echo e(__('Total Users')); ?></span>
                </a>
                <div class="card-inner d-flex align-items-end justify-content-between gap-2">
                    ...
                    <div class="card-info text-end">
                        <h3 class="mb-3 h2"><?php echo e($user->total_user); ?></h3>
        ...
        <div class="col-xxl-4 col-md-6 dash-card">
            <div class="dashboard-info-card">
                ...
                <a href="<?php echo e(route('order.index')); ?>" class="top-info">
                    <span class="h4"><?php echo e(__('Total Orders')); ?></span>
                </a>
                <div class="card-inner d-flex align-items-end justify-content-between gap-2">
                    <div class="info-icon">
                        <div class="info-icon-inner">
                    ...
                    <div class="card-info text-end">
                        <h3 class="mb-3 h2"><?php echo e($user->total_orders); ?></h3>
                        <div class="card-label d-flex align-items-center gap-1">
                            <?php echo e(__('Total Amount : ')); ?>

                            <span><?php echo e((isset($admin_payment_setting['CURRENCY_SYMBOL']) ? $admin_payment_setting['CURRENCY_SYMBOL']  : '$') . $user['total_orders_price']); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xxl-4 col-md-6 dash-card">
            <div class="dashboard-info-card">
                ...
                <a href="<?php echo e(route('plans.index')); ?>" class="top-info">
                    <span class="h4"><?php echo e(__('Total Plans')); ?></span>
                </a>
                <div class="card-inner d-flex align-items-end justify-content-between gap-2">
                    <div class="info-icon">
                        <div class="info-icon-inner">
                    ...
                    <div class="card-info text-end">
                        <h3 class="mb-3 h2"><?php echo e($user->total_plan); ?></h3>
                        <div class="card-label d-flex align-items-center gap-1">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/dashboard/admin_dashboard.blade.php ENDPATH**/ ?>