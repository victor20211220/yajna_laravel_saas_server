                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td width="5%"><input type="checkbox" class="form-check-input ischeck" name="checkall" data-id="<?php echo e(str_replace(' ', '', $module)); ?>" ></td>
                                    <td width="8%"><label class="ischeck" data-id="<?php echo e(str_replace(' ', '', $module)); ?>"><?php echo e(ucfirst($module)); ?></label></td>
                                    <td>
                                        <div class="row gy-2">
...
<?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/role/edit.blade.php ENDPATH**/ ?>