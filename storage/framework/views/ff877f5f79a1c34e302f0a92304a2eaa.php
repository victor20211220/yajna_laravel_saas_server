<?php echo e(Form::open(['url' => route('category.store'), 'enctype' => 'multipart/form-data','class' => 'needs-validation', 'novalidate'])); ?>

<div class="row">
    <div class="form-group col-12">
        <?php echo e(Form::label('category_name', __('Category Name'), ['class' => 'form-label'])); ?><?php if (isset($component)) { $__componentOriginaleab1765d328ab3f8835fc5d78676a070 = $component; } ?>
...
<?php endif; ?>
        <?php echo Form::text('name',null, ['class' => 'form-control ', 'required' => 'required','placeholder'=>__('Category Name')]); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-12 form-group img-validate-class">
        <?php echo e(Form::label('category_image', __('Category Logo'), ['class' => 'form-label'])); ?><?php if (isset($component)) { $__componentOriginaleab1765d328ab3f8835fc5d78676a070 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaleab1765d328ab3f8835fc5d78676a070 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.required','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?>
        ...
        <div class="col-md-4 mt-2">
            <img src="<?php echo e(asset('custom/img/placeholder-image21.jpg')); ?>" id="category_icon" width="100%" class="border border-2 border-primary rounded"/>
        </div>
...
<?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/business_category/create.blade.php ENDPATH**/ ?>