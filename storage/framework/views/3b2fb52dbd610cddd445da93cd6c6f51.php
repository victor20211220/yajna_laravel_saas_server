...
<?php if($themeName): ?>
<div class="<?php echo e($themeName); ?>" id="view_theme19">
<?php else: ?>
<div class="<?php echo e($business->theme_color); ?>" id="view_theme19">
<?php endif; ?>
     <main id="boxes">
            ...
            <section class="profile-sec pb">
                <div class="profile-banner-wrp">
                    <div class="profile-banner img-wrapper">
                        <img src="<?php echo e(isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme19/images/profile-banner-img.png')); ?>" class="profile-banner-image" alt="profile-banner" id="banner_preview"
                        loading="lazy">
                    </div>
                </div>
                <div class="container">
                    <div class="client-info-wrp">
                        ...
                        <div class="client-image">
                            <img id="business_logo_preview"  src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme19/images/client-image.png')); ?>"   alt="client-image" loading="lazy">
                        </div>
                                    ...
                                    <?php if($social_key1 != 'id'): ?>
                                        <div class="social-link"  id="socials_<?php echo e($loop->parent->index + 1); ?>">
                                            ...
                                            <a href="<?php echo e($social_links); ?>" target="_blank"   id="<?php echo e('social_link_' . $social_nos . '_href_preview'); ?>">
                                                <img src="<?php echo e(asset('custom/theme19/icon/social/' . strtolower($social_key1) . '.svg')); ?>" alt="social-image" loading="lazy">
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                    <?php
                                            ...
                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>" class="d-flex align-items-center">
                                                <?php if($key1 == 'Address'): ?>
                                                    ...
                                                    <div class="contact-image">
                                                        <img src="<?php echo e(asset('custom/theme19/icon/color1/' . strtolower($key1) . '.svg')); ?>" class="img-fluid">
                                                    </div>
...
<?php echo $__env->make('card.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/card/theme19/index.blade.php ENDPATH**/ ?>