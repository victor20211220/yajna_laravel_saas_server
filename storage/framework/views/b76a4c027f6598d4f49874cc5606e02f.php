...
<?php unset($__componentOriginaleab1765d328ab3f8835fc5d78676a070); ?>
<?php endif; ?>
                                                <?php echo e(Form::text('discover_buy_now_link', $settings['discover_buy_now_link'], ['class' => 'form-control', 'placeholder' => __('Enter Link'),'required'=>'required'])); ?>
                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-3 justify-content-end d-flex">
                                        <a data-size="lg" data-url="<?php echo e(route('discover_create')); ?>" data-ajax-popup="true"  data-bs-toggle="tooltip"
                                            data-title="<?php echo e(__('Create Discover')); ?>"  class="btn btn-sm btn-primary" title="<?php echo e(__('Create Discover')); ?>">
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="action-btn me-2">
                                                                        <a href="#" class="mx-3 bg-info btn btn-sm align-items-center" data-url="<?php echo e(route('discover_edit',$key)); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Edit Discover')); ?>" data-size="lg" data-bs-toggle="tooltip"  title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/Modules/LandingPage/Resources/views/landingpage/discover/index.blade.php ENDPATH**/ ?>