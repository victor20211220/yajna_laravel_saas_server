...
<?php $__env->startSection('action-btn'); ?>
    ...
    <?php else: ?>
        <div
            ...
            <a href="<?php echo e(route('order.request.index')); ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
        ...
        <?php if(\Auth::user()->type == 'super admin'): ?>
                                ...
                                <div class="btn-group card-option">
                                    ...
                                    <div class="dropdown-menu icon-dropdown dropdown-menu-end">
                                        <a data-url="<?php echo e(route('nfc.edit', $nfcCard->id)); ?>" data-size="md"
                                            data-ajax-popup="true" class="dropdown-item user-drop"  title="<?php echo e(__('Edit')); ?>"
                                        ...
                                        <div class="avatar-parent-child nfc-image">
                                            ...
                                            <?php if($headers && strpos($headers[0], '200')): ?>
                                                <img
                                                    ...
                                                    alt="">
                                            <?php elseif(is_null($nfcCard->image)): ?>
                                                <img
                                                    src="<?php echo e(isset($nfcCard->image) && !empty($nfcCard->image) ? $nfcImage . '/' . $nfcCard->image : asset('custom/img/placeholder-image21.jpg')); ?>"
                                                    alt="">
                                            <?php else: ?>
                                                <img
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6">
                <a class="btn-addnew-project border-primary" data-ajax-popup="true" data-size="md"
                    ...
                    <div class="badge bg-primary proj-add-icon" data-bs-placement="top" data-bs-toggle="tooltip"  data-bs-original-title="<?php echo e(__('Create New NFC Card')); ?>">
                        <i class="ti ti-plus"></i>
                    </div>
                    <h6 class="mt-3 mb-2"><?php echo e(__('New NFC Card')); ?></h6>
                        ...
                        <div class="card-body">
                            ...
                            <?php if($headers && strpos($headers[0], '200')): ?>
                                <img class="image rounded"
                                    ...
                                    alt="">
                            <?php else: ?>
                                <img class="image rounded" src="<?php echo e(asset('custom/nfcimg/nfc' . $key + 1 . '.png')); ?>" alt="">
                            <?php endif; ?>
                        </div>

                            <div class="nfc-card-content">
                                    <div class="title-info d-flex align-items-center justify-content-between">
                                        <a data-url="<?php echo e(route('nfc.order', $nfcCard->id)); ?>" data-size="md" class="nfc-cart-icon"
                                            data-ajax-popup="true"
                                            data-bs-whatever="<?php echo e(__('Order NFC Card')); ?>" data-bs-toggle="tooltip"
                                            data-bs-title="<?php echo e(__('Order NFC Card')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/nfc/index.blade.php ENDPATH**/ ?>