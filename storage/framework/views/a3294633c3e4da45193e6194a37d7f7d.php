<?php if($themeName): ?>
    <div class="<?php echo e($themeName); ?>">
<?php else: ?>
    <div class="<?php echo e($business->theme_color); ?>">
<?php endif; ?>
    <!-- appointment-popup -->
            ...
            <div class="theme-popup-content popup-scroll">
                <div class="popup-header d-flex align-items-center justify-content-between">
                    <div class="popup-title d-flex align-items-center">
                        ...
                        <h2><?php echo e(__('Make Appointment')); ?></h2>
                    </div>
                ...
                <div class="popup-footer text-center">
                    <button type="button" class="btn" id="makeappointment"><?php echo e('Make Appointment'); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="theme-popup gallery-popup d-flex align-items-center" id="gallerymodel">
        <div class="theme-popup-inner">
            <div class="theme-popup-content popup-scroll">
                ...
                <div class="popup-footer text-center">
                    <button type="button" class="btn gallery-close"><?php echo e(__('Close')); ?></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="theme-popup video-popup d-flex align-items-center" id="videomodel">
        <div class="theme-popup-inner">
            <div class="theme-popup-content popup-scroll">
                ...
                <div class="popup-footer text-center">
                    <button type="button" class="btn video-close"><?php echo e(__('Close')); ?></button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="theme-popup-content popup-scroll">
                <div class="popup-header d-flex align-items-center justify-content-between">
                    <div class="popup-title d-flex align-items-center">
                        ...
                        <h2><?php echo e(__('Make Contact')); ?></h2>
                    </div>
                ...
                <form action="">
                    ...
                    <div class="popup-footer text-center">
                        <button type="button" class="btn" id="makecontact"><?php echo e(__('Make Contact')); ?></button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="theme-popup-content popup-scroll">
                <div class="popup-header d-flex align-items-center justify-content-between">
                    <div class="popup-title d-flex align-items-center">
                        ...
                        <h2><?php echo e(__('Share This Card')); ?></h2>
                    </div>
                ...
                <div class="popup-body">
                    <div class="client-image">
                        <img id="business_logo_preview"
                            src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme1/images/developer-banner-bottom.png')); ?>"
                    ...
                    <p><?php echo e(__('Point your camera at the QR code,')); ?></p>
    ...
    <div class="theme-popup password-popup d-flex align-items-center" id="passwordmodel">
        <div class="theme-popup-inner">
            <div class="theme-popup-content popup-scroll">
                ...
                <div class="popup-footer text-center">
                    <button type="button" class="btn password-submit"><?php echo e(__('Submit')); ?></button>
                </div>
            </div>
        </div>
    </div>
...
?>
<script src="<?php echo e(asset('custom/' . $theme . '/js/jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('custom/' . $theme . '/js/slick.min.js')); ?>" defer="defer"></script>


<script src="<?php echo e(asset('custom/js/jquery.qrcode.min.js')); ?>"></script>


<script src="<?php echo e(asset('custom/' . $theme . '/js/picker.js')); ?>"></script>
<script src="<?php echo e(asset('custom/' . $theme . '/js/picker.date.js')); ?>"></script>
...
<?php if($SITE_RTL == 'on'): ?>
    <script src="<?php echo e(asset('custom/' . $theme . '/js/rtl-custom.js')); ?>" defer="defer"></script>
<?php else: ?>
    <script src="<?php echo e(asset('custom/' . $theme . '/js/custom.js')); ?>" defer="defer"></script>
<?php endif; ?>
...
<script>
    ...
    var is_enabled = "<?php echo e(Business::EnableOrNot($businesshours, $business_hours)); ?>";
    if (is_enabled) {
    ...
    var is_contact_enable = "<?php echo e(Business::EnableOrNot($contactinfo, $contactinfo_content)); ?>";
    ...
    var is_enable_appoinment = "<?php echo e(Business::EnableOrNot($appoinment, $appoinment_hours)); ?>";
    ...
    var is_enable_service = "<?php echo e(Business::EnableOrNot($services, $services_content)); ?>";
    if (is_enable_service) {
        $('#services-div').show();
    } else {
        $('#services-div').hide();
    }
    var is_enable_product = "<?php echo e(Business::EnableOrNot($products, $products_content)); ?>";
    ...
    var is_enable_testimonials = "<?php echo e(Business::EnableOrNot($testimonials, $testimonials_content)); ?>";
    ...
    var is_enable_gallery = "<?php echo e(Business::EnableOrNot($gallery, $gallery_contents)); ?>";
    if (is_enable_gallery) {
        $('#gallery-div').show();
    } else {
        $('#gallery-div').hide();
    }
    var is_payment = "<?php echo e(Business::EnableOrNot($cardPayment, $cardPayment_content)); ?>";
    if (is_payment) {
    ...
    var is_svg_enabled = "<?php echo e($is_svg_enabled); ?>";
    if (is_svg_enabled) {
        $('#svg-div').show();
    } else {
        $('#svg-div').hide();
    }
    var is_payment_enabled = "<?php echo e($is_enabled); ?>";
...
<?php if(isset($is_slug)): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/card/footer.blade.php ENDPATH**/ ?>