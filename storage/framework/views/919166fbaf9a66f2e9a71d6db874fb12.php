                ...
                <section class="profile-sec pb">
                    <div class="profile-banner img-wrapper">
                        <img class="profile-banner-img"
                            src="<?php echo e(isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme6/images/profile-banner-img.png')); ?>"
                        ...
                        <div class="client-info-wrp">
                            <div class="client-info-content d-flex">
                                <div class="client-image">
                                    <img id="business_logo_preview"  src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme6/images/client-image.png')); ?>"
                                    alt="client-image" loading="lazy">
                                </div>
                                <div class="client-info">
                                    <h2 id="<?php echo e($stringid . '_title'); ?>_preview"><?php echo e($business->title); ?></h2>
                                    <span id="<?php echo e($stringid . '_designation'); ?>_preview">
                                        <?php echo e($business->designation); ?></span>
                                    <span class="subtitle"
                                        ...
                                        <li id="contact_<?php echo e($loop->parent->index + 1); ?>" class="d-flex align-items-center">
                                            <?php if($key1 == 'Address'): ?>
                                                ...
                                                <div class="contact-image">
                                                    <img src="<?php echo e(asset('custom/theme6/icon/color1/' . strtolower($key1) . '.svg')); ?>" class="img-fluid">
                                                </div>
                                        ...
                                        <?php if($social_key1 != 'id'): ?>
                                            <div class="social-link"  id="socials_<?php echo e($loop->parent->index + 1); ?>">
                                                ...
                                                <a href="<?php echo e($social_links); ?>" target="_blank"   id="<?php echo e('social_link_' . $social_nos . '_href_preview'); ?>">
                                                    <img src="<?php echo e(asset('custom/theme6/icon/social/' . strtolower($social_key1) . '.svg')); ?>" alt="social-image" loading="lazy">
                                                </a>
                                            </div>
                                        <?php endif; ?>
                                        <?php
                        ...
                        <div class="slider-wrapper">
                                        ...
                                        <div class="product-card-inner">
                                            <div class="product-card-image">
                                                <div class="img-wrapper">
                                                    <img id="<?php echo e('product_image'.$pr_image_count .'_preview'); ?>" src="<?php echo e(isset($content->image) && !empty($content->image) ? $pr_image . '/' . $content->image : asset('custom/img/logo-placeholder-image-21.png')); ?>" alt="product-image" loading="lazy">
                                                </div>
                                            </div>
                                            <div class="product-content">
                                                ...
                                                <div
                                                    ...
                                                    <?php if(!empty($content->purchase_link)): ?>
                                                        <a href="<?php echo e(url($content->purchase_link)); ?>" class="btn"><?php echo e($content->link_title); ?></a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <?php else: ?>
                                <div class="product-sec-slider" id="inputrow_product_preview">
                                    <?php $pr_image_counts = 0; ?>
                                    <?php $__currentLoopData = $products_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k1 => $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="product-card" id="product_<?php echo e($product_row_nos); ?>">
                                            <div class="product-card-inner">
                                                <div class="product-card-image">
                                                    <div class="img-wrapper">
                                                        <img id="<?php echo e('product_image'.$pr_image_counts .'_preview'); ?>" src="<?php echo e(isset($content->image) && !empty($content->image) ? $pr_image . '/' . $content->image : asset('custom/img/logo-placeholder-image-21.png')); ?>" alt="product-image" loading="lazy">
                                                    </div>
                                                </div>
                                                <div class="product-content">
                                                    <div class="product-content-top">
                    ...
                    <section class="custom-text-sec pb" id="svg-div">
                        <div class="container">
                            <div class="thankyou-svg">
                                <?php if(isset($business->svg_text)): ?>
...
<?php echo $__env->make('card.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/card/theme6/index.blade.php ENDPATH**/ ?>