...
<?php if($themeName): ?>
<div class="<?php echo e($themeName); ?>" id="view_theme17">
<?php else: ?>
<div class="<?php echo e($business->theme_color); ?>" id="view_theme17">
<?php endif; ?>
        <main id="boxes">
                    ...
                    <section class="profile-sec pb">
                        <div class="profile-banner-wrp">
                            <div class="profile-banner img-wrapper">
                                <img src="<?php echo e(isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme17/images/profile-banner-img.png')); ?>" class="profile-banner-image" alt="profile-banner" id="banner_preview" loading="lazy">
                                <div class="profile-label">
                                    <span id="<?php echo e($stringid . '_designation'); ?>_preview"><?php echo e($business->designation); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="container">
                            <div class="client-info-wrp">
                                <div class="client-image">
                                    <img id="business_logo_preview"  src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme17/images/client-image.png')); ?>"   alt="client-image" loading="lazy">
                                </div>
                            ...
                            <section class="testimonial-sec pb" id="testimonials-div">
                                <div class="container">
                                    ...
                                    <?php
                                        $t_image_count = 0;
                                    ?>
                                    <div class="testimonial-slider-wrp d-flex" id="testimonials_<?php echo e($testimonials_row_nos); ?>">
                                                ...
                                                <div class="testimonial-content-wrp">
                                                    <div class="testimonial-content">
                                                        <div class="testimonial-content-top">
                                                            ...
                                                            <span><?php echo e(isset($testi_content->title) ? $testi_content->title : ''); ?></span>
                                                        </div>
                                                        <div class="testimonial-content-bottom">
                                                            <p id="<?php echo e('testimonial_description_' . $testimonials_row_nos . '_preview'); ?>">
                                                                <?php echo e(isset($testi_content->description) ? $testi_content->description : ''); ?>
                                                        ...
                                                        <li id="contact_<?php echo e($loop->parent->index + 1); ?>" class="d-flex align-items-center">
                                                            <?php if($key1 == 'Address'): ?>
                                                                ...
                                                                <div class="contact-image">
                                                                    <img src="<?php echo e(asset('custom/theme17/icon/color1/' . strtolower($key1) . '.svg')); ?>" class="img-fluid">
                                                                </div>
...
<?php echo $__env->make('card.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/card/theme17/index.blade.php ENDPATH**/ ?>