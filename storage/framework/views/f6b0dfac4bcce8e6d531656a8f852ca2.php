    ...
    <form class="px-3" method="post" action="<?php echo e(route('test.send.mail')); ?>" id="test_email">
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control" id="email" name="email" required placeholder="<?php echo e(__('Enter Email')); ?>"/>
            </div>
            <div class="col-md-12 mb-2 text-end">
                <label id="email_sending" style="display: none;"><i class="fas fa-clock"></i></label>
                <input type="button" value="<?php echo e(__('Cancel')); ?>" class="btn btn-secondary me-1" data-bs-dismiss="modal">
                <input type="submit" value="<?php echo e(__('Send Test Mail')); ?>" class="btn-create btn btn-primary">
            </div>
        </div>
    </form>

<?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/settings/test_mail.blade.php ENDPATH**/ ?>