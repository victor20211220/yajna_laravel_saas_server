...
<?php if($themeName): ?>
<div class="<?php echo e($themeName); ?>" id="view_theme18">
<?php else: ?>
<div class="<?php echo e($business->theme_color); ?>" id="view_theme18">
<?php endif; ?>
     <main id="boxes">
            ...
            <div class="influencer-card">
                <section class="profile-sec pb">
                    <div class="profile-banner img-wrapper">
                        <img src="<?php echo e(isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme8/images/profile-banner-img.png')); ?>" alt="profile-banner-img" id="banner_preview" loading="lazy">
                    ...
                    <div class="container">
                        <div class="client-info-wrp text-center">
                            <div class="client-image">
                                <img id="business_logo_preview"  src="<?php echo e(isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme8/images/client-image.png')); ?>"   alt="client-image" loading="lazy">
                            </div>
                                            ...
                                            <div class="service-content">
                                                ...
                                                <div class="service-content-bottom text-center">
                                                    ...
                                                    <a href="<?php echo e(url($content->purchase_link)); ?>"
                                                        ...
                                                        class="btn btn-white"><?php echo e($content->link_title); ?>
                            ...
                            <?php if(!is_null($contactinfo_content) && !is_null($contactinfo)): ?>
                                <?php $__currentLoopData = $contactinfo_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $__currentLoopData = $val; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key1 => $val1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        ?>
                                        <?php if($key1 != 'id'): ?>
                                            <li id="contact_<?php echo e($loop->parent->index + 1); ?>" class="flex align-items-center justify-content-center">
                                                <?php if($key1 == 'Address'): ?>
                                                    ...
                                                    <div class="contact-image">
                                                        <img src="<?php echo e(asset('custom/theme8/icon/color1/' . strtolower($key1) . '.svg')); ?>" class="img-fluid">
                                                    </div>
                ...
                <section class="more-info-sec pb">
                    <div class="container">
                        ...
                        <ul class="d-flex justify-content-center">
                            <li>
                                <a href="<?php echo e(route('bussiness.save', $business->slug)); ?>" class="save-info d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="testimonial-content">
                                                <div class="testimonial-content-top">
                                                    <div class="rating d-flex align-items-center ">
                                                        ...
                                                        <span class="total-rat"><?php echo e($testi_content->rating); ?>.0  rating</span>
                                                    </div>
...
<?php echo $__env->make('card.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u877293075/domains/graphixjunctionvcard.com/public_html/resources/views/card/theme8/index.blade.php ENDPATH**/ ?>