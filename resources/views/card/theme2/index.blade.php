...
@if($themeName)
    <div class="{{ $themeName }}" id="view_theme12">
@else
    <div class="{{ $business->theme_color }}" id="view_theme12">
@endif
      <main id="boxes">
                ...
                <section class="profile-sec bg-light pb mb">
                    <div class="container">
                        <div class="profile-banner">
                            ...
                            src="{{ isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme2/images/profile-banner.jpg') }}"
                            ...
                            <div class="client-info-wrp d-flex align-items-center">
                                <div class="client-image">
                                    <img id="business_logo_preview"  src="{{ isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme2/images/client-image.png') }}"
                                alt="client-image" loading="lazy">
                                </div>
                                <div class="client-info">
                                    <h3 id="{{ $stringid . '_designation' }}_preview">
                                                    ...
                                                    <li id="contact_{{ $loop->parent->index + 1 }}" class="d-flex align-items-center justify-content-center">
                                                        @if ($key1 == 'Address')
                                                            @foreach ($val1 as $key2 => $val2)
                                                                ...
                                                                @endif
                                                            @endforeach
                                                                <img src="{{ asset('custom/theme2/icon/color1/' . strtolower($key1) . '.svg') }}" class="img-fluid">
                                                ...
                                                <div class="service-card-inner">
                                                    <div class="service-content-top">
                                                        <div class="service-name-wrp d-flex align-items-center">
                                                            ...
                                                            <h3 id="{{ 'title_' . $service_row_nos . '_preview' }}">
                                                                {{ $content->title }}</h3>
                                                        </div>
                                                        <p id="{{ 'description_' . $service_row_nos . '_preview' }}">
                                                    ...
                                                    <div class="service-content-bottom text-right">
                                                        @if (!empty($content->purchase_link))
                                                            <a href="{{ url($content->purchase_link) }}"
                                                                ...
                                                                class="readmore-btn">{{ $content->link_title }}</a>
                                                        @endif
                                                        {{-- <a href="https://demo.workdo.io/" class="readmore-btn">Read More</a> --}}
                                                    </div>
                                                </div>
                                            </div>
                                                @php
                                                    ...
                                                    @if ($social_key1 != 'id')
                                                        <div class="social-link"  id="socials_{{ $loop->parent->index + 1 }}">
                                                            ...
                                                            <a href="{{ $social_links }}" target="_blank"   id="{{ 'social_link_' . $social_nos . '_href_preview' }}">
                                                                <img src="{{ asset('custom/theme2/icon/social/' . strtolower($social_key1) . '.svg') }}" alt="social-image" loading="lazy">
                                                            </a>
                                                        </div>
                                                    @endif
                                                    @php
                                                    ...
                                                    <div class="testimonial-content">
                                                        ...
                                                        <div class="testimonial-content-bottom d-flex align-items-center justify-content-between">
                                                            ...
                                                            <div class="rating d-flex align-items-center">
                                                                ...
                                                                @endphp
                                                                <span id="{{ 'stars' . $testimonials_row_nos }}_star"
                                                                    class="stars">
                                                                    @for ($i = 1; $i <= 5; $i++)
                                                                        @if ($overallrating < $i)
                            ...
                            <section class="download-sec pb" id="app-section">
                                ...
                                <div class="container">
                                        <ul class="d-flex align-items-center">
                                            <li>
                                                <a href="{{ $appInfo->playstore_id }}" class="d-flex align-items-center justify-content-center" target="_blank">
                                                    <img src="{{ asset('custom/icon/apps/playstore' . $appInfo->variant . '.png') }}" alt="app-store" loading="lazy">
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ $appInfo->appstore_id }}" class="d-flex align-items-center justify-content-center" target="_blank">
                                                    <img src="{{ asset('custom/icon/apps/appstore' . $appInfo->variant . '.png') }}" alt="app-store" loading="lazy">
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
