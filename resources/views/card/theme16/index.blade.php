                    ...
                    <section class="profile-sec pb">
                        <diTv class="profile-banner-wrp">
                            <div class="profile-banner img-wrapper">
                                <img src="{{ isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme16/images/profile-banner.png') }}" class="profile-banner-image" alt="profile-banner" id="banner_preview" loading="lazy">
                            </div>
                        </div>
                        <div class="container">
                            <div class="client-info-wrp d-flex align-items-center">
                                <div class="client-image">
                                    <img id="business_logo_preview"  src="{{ isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme16/images/client-image.png') }}"   alt="client-image" loading="lazy">
                                </div>
                                                        ...
                                                        <li id="contact_{{ $loop->parent->index + 1 }}" class="d-flex align-items-center">
                                                            @if ($key1 == 'Address')
                                                                ...
                                                                <div class="contact-image">
                                                                    <img src="{{ asset('custom/theme16/icon/color1/' . strtolower($key1) . '.svg') }}" class="img-fluid">
                                                                </div>
