                    ...
                    <section class="profile-sec pb">
                        <div class="profile-banner">
                            ...
                            <img class="profile-banner-img"
                                src="{{ isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme1/images/developer-card-banner.png') }}"
                                id="banner_preview" alt="fs">

                            <img src="{{ asset('custom/theme1/images/developer-banner-bottom.png') }}" class="banner-bottom"
                        ...
                        <div class="client-info-wrp text-center">
                            ...
                            <div class="client-image">
                                <img id="business_logo_preview"
                                    src="{{ isset($business->logo) && !empty($business->logo) ? $logo . '/' . $business->logo : asset('custom/theme1/images/client-image.png') }}"
                                    alt="">
                            </div>
                                                        ...
                                                        @if ($key1 != 'id')
                                                            <li id="contact_{{ $loop->parent->index + 1 }}" class="d-flex align-items-center">
                                                                @if ($key1 == 'Address')
                                                                    ...
                                                                    @endforeach
                                                                    <span>
                                                                        <img src="{{ asset('custom/theme1/icon/color1/' . strtolower($key1) . '.svg') }}" class="img-fluid">
                                                                    </span>
                                                        ...
                                                        <div class="service-card-inner">
                                                            <div class="service-content-top">
                                                                <h3 id="{{ 'title_' . $service_row_nos . '_preview' }}">
                                                                    {{ $content->title }}</h3>
                                                                <p
                                                                    id="{{ 'description_' . $service_row_nos . '_preview' }}">
                                                                    {{ $content->description }} </p>
                                                            </div>
                                                            <div
                                                                class="service-content-bottom d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="appointment-form">
                                                ...
                                                @if (!is_null($appoinment_hours))
                                                    @foreach ($appoinment_hours as $k => $hour)
                                                        <li class="checkbox-custom"
                                                            id="{{ 'appointment_' . $appointment_nos }}">
                                                            <input type="radio" id="radio-{{ $radiocount }}"
                                                            ...
                                                            <label for="radio-{{ $radiocount }}">
                                                                <span
                                                                    id="appoinment_start_{{ $appointment_nos }}_preview">
                                                                    @if (!empty($hour->start))
                                                                        {{ $hour->start }}
                                                                    @else
                                                                        00:00
                                            ...
                                            <div class="text-center">
                                                <button type="button"
                                                    class="btn appointment-btn">{{ __('Make An Appointment') }}</button>
                                            </div>
                                        </div>
                                </section>
                            @endif
                                                    ...
                                                    <div class="product-card-inner">
                                                        ...
                                                        <div class="product-content">
                                                            <div class="product-content-top">
                                                                <h3
                                                                    id="{{ 'product_title_' . $product_row_nos . '_preview' }}">
                                                                    {{ $content->title }}</h3>
                                                                <p
                                                                    id="{{ 'product_description_' . $product_row_nos . '_preview' }}">
                                                                    {{ $content->description }}</p>
                                                            </div>
                                                            <div
                                        ...
                                        @if (isset($is_pdf))
                                            ...
                                            @foreach ($testimonials_content as $k2 => $testi_content)
                                                <div class="testimonial-card edit-card"
                                                    id="testimonials_{{ $testimonials_row_nos }}">
                                                    <div class="testimonial-card-inner d-flex">
                                                        ...
                                                        <div class="testimonial-content">
                                                            <div
                                                                ...
                                                                <h3
                                                                    id="{{ 'testimonial_name_' . $testimonials_row_nos . '_preview' }}">
                                                            ...
                                                            <p
                                                                id="{{ 'testimonial_description_' . $testimonials_row_nos . '_preview' }}">
                                                        ...
                                                        @if ($social_key1 != 'id')
                                                            <div class="social-link"
                                                                ...
                                                                <a href="{{ $social_links }}" target="_blank"
                                                                    id="{{ 'social_link_' . $social_nos . '_href_preview' }}">
