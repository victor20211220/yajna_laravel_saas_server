                ...
                <section class="profile-sec pb">
                    <div class="profile-banner-wrp">
                        <div class="profile-banner img-wrapper">
                            <img src="{{ isset($business->banner) && !empty($business->banner) ? $banner . '/' . $business->banner : asset('custom/theme13/images/profile-banner.png') }}" alt="profile-banner-img" id="banner_preview"  class="profile-banner-img" loading="lazy">
                        </div>
                    </div>
                    <div class="container">
                                            ...
                                            <li id="contact_{{ $loop->parent->index + 1 }}" class="d-flex align-items-center">
                                                @if ($key1 == 'Address')
                                                    ...
                                                    <div class="contact-image">
                                                        <img src="{{ asset('custom/theme13/icon/color1/' . strtolower($key1) . '.svg') }}" class="img-fluid">
                                                    </div>
