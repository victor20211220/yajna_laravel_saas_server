                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            @foreach($modules as $module)
                                <tr>
                                    <td width="5%"><input type="checkbox" class="form-check-input ischeck" name="checkall" data-id="{{str_replace(' ', '', $module)}}" ></td>
                                    <td width="8%"><label class="ischeck" data-id="{{str_replace(' ', '', $module)}}">{{ ucfirst($module) }}</label></td>
                                    <td>
                                        <div class="row gy-2">
