<div class="row pb-2">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <a href="{{ asset(Storage::url('bank_receipt')) . '/' . $order->receipt }}"
...
<div class="modal-footer p-0 pt-3">
    <a href="{{ route('change.status', [$order->id, 1]) }}" class="btn btn-success btn-xs">
        {{ __('Approve') }}
    </a>
    <a href="{{ route('change.status', [$order->id, 0]) }}" class="btn btn-danger btn-xs">
        {{ __('Reject') }}
    </a>
