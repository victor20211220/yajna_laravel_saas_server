    ...
    <div class="row row-gap mb-4">
        <div class="col-xxl-4 col-md-6 dash-card">
            <div class="dashboard-info-card">
                <svg class="star" xmlns="http://www.w3.org/2000/svg" width="83" height="79" viewBox="0 0 83 79"
                     fill="none">
                    <path opacity="0.16"
                          ...
                          fill="#FF3A6E"/>
                    <path opacity="0.16"
                          d="M78.2765 61.7004C73.0978 65.7903 72.3986 67.7051 73.4625 74.8815C69.2811 68.9531 67.4538 68.0497 60.8834 68.6633C66.0618 64.5725 66.761 62.6578 65.6963 55.4816C69.8785 61.4097 71.7058 62.3131 78.2765 61.7004Z"
                          fill="#FF3A6E"/>
                </svg>
                <a href="#" class="top-info">
                    <span class="h4">{{ __('Total Business Cards') }}</span>
                </a>
                <div class="card-inner d-flex align-items-end justify-content-between gap-2">
                    ...
                    {{--                    </div>--}}
                    <div class="card-info text-end">
                        <h3 class="mb-3 h2">{{ $new_stats_data['total_businesses'] }}</h3>
                        <div class="card-label d-flex align-items-center gap-1">
                            {{ __('Total Business Cards') }}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xxl-4 col-md-6 dash-card">
            <div class="dashboard-info-card">
                ...
                <a href="#" class="top-info">
                    <span class="h4">{{ __('Total Views') }}</span>
                </a>
                <div class="card-inner d-flex align-items-end justify-content-between gap-2">
                    <div class="info-icon">
                        <div class="info-icon-inner">
                    ...
                    <div class="card-info text-end">
                        <h3 class="mb-3 h2">{{ $new_stats_data['total_views'] }}</h3>
                        <div class="card-label d-flex align-items-center gap-1">
                            {{ __('Total Views') }}
                        </div>
                    </div>
        ...
        <div class="col-xxl-4 col-md-6 dash-card">
            <div class="dashboard-info-card">
                ...
                <a href="#" class="top-info">
                    <span class="h4">{{ __('Total Clicks') }}</span>
                </a>
                <div class="card-inner d-flex align-items-end justify-content-between gap-2">
                    <div class="info-icon">
                        <div class="info-icon-inner">
                    ...
                    <div class="card-info text-end">
                        <h3 class="mb-3 h2">{{ $new_stats_data['total_clicks'] }}</h3>
                        <div class="card-label d-flex align-items-center gap-1">
                            {{ __('Total Clicks') }}
                        </div>
                    </div>
