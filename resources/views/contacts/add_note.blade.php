...
@endphp
{{ Form::open(['route' => ['contact.note.store', $contact->id],'class' => 'needs-validation', 'novalidate']) }}
...
<div class="row">
    ...
    <div class="col-12 form-group mt-4">
        <div class="row gutters-xs">
            ...
            <div class="col-12">
                <textarea class="summernote" row="10" cols="50" id="note" name="note" placeholder="{{__('Enter your notes here...')}}">{!! $contact->note !!}</textarea>
            </div>
        </div>
    </div>
</div>
