  ...
  <head>
    ...
    <title>@if(Auth::user()->type == 'super admin')  {{config('app.name', 'vCard SaaS')}} @else {{(\App\Models\Utility::getValByName('title_text')) ? \App\Models\Utility::getValByName('title_text') : config('app.name', 'vCard SaaS')}} @endif</title>
