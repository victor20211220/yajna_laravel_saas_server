        ...
        <div class="card-body px-md-5 py-5">
            ...
            <form action="{{ route('password.confirm') }}" method="POST" class="pt-3 text-left needs-validation" novalidate="">
              ...
              <label class="d-block position-relative mb-3">
                ...
                <input type="password" id="password" name="password" placeholder="{{__('Enter Password')}}"  class="text-sm rounded-6 w-100 py-3 px-3 border text-grayDark @error('password') is-invalid @enderror" >
                @error('password')
