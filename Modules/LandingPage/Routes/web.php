...
use Modules\LandingPage\Http\Controllers\BusinessCampaignController;
...
Route::get('directory/home', [MarketplaceController::class, 'index'])->name('marketplace.home');
...
Route::get('/business-directory', [MarketplaceController::class, 'landingHome'])->name('landingpage.backhome');
