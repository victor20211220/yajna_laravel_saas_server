    ...
    <a href="{{ route('business-campaigns.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'business-campaigns.index') ? ' active' : '' }}">{{ __('Business Campaigns') }} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
